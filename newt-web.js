...
Copyright (C) 2011-2016 Kenneth H. Slater
...
var scope = {
	spec: { // This is what the user specifies, and what is saved in a file
	    ...
	    title: "Default Newt-Web Telescope Design",
	    notes: "Make changes on the Specification Pane",
	    unit_meas: "inch",	//inch, cm, mm
	    primary_diam: 6.0,
	    f_ratio: 8.0,
    	secondary_minor: 1.5,
	    tube_id: 7.0,
	    tube_thick: 0.125,
	    focus_to_tubefront: 6,
	    pri_fnt_tube_back: 3.5,		// Primary Front to Back of Tube (was 'mirror_front')
	    fixed_baffles: false,
	    focus_height: 3.0,
	    focus_extra: 0.25,
	    focus_camera: 0.0,
	    focus_diam: 1.25,
	    eye_fl: new Array(35,25, 9,0,0,0,0,0,0,0), //[10]
        eye_af: new Array(35,68,40,0,0,0,0,0,0,0)  //[10]
	},
